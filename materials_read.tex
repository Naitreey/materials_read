...
\begin{enumerate}
    ...
    \item shell utils and commands:
        \begin{enumerate}
            \item bash, printf, echo, cd, pwd, export, type, fg, bg, jobs, umask, test, while, case, exit, shift, if, for, source, declare, read, continue, break, trap, exec, eval, dirs, pushd, popd, ulimit, hash, [[ ]], builtin, command, enable, shopt, set, unset, readonly, history, time, kill, alias, unalias
