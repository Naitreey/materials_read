...
\begin{enumerate}
    ...
    \item shell utils and commands:
        \begin{enumerate}
            ...
            \item vncviewer
            \item okular
            \item git (init|clone|branch|mv|status|remote|merge|mergetool|merge-base|pull|fetch|push|commit|log|checkout|ls-files|rm|add|stash|config|diff|difftool|apply|rebase|reset|tag|show|instaweb|clean|cherry-pick|reflog|request-pull|format-patch|am|send-email|rev-parse), git-shell, gitignore(5), gitrevisions(7)
