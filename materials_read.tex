...
\begin{enumerate}
    ...
    \item shell utils and commands:
        \begin{enumerate}
            \item bash, :, ., source, printf, echo, cd, pwd, type, fg, bg, jobs, umask, exit, if, case, select, read, trap, exec, eval, dirs, pushd, popd, ulimit, hash, [[ ]], test (\verb|[|), builtin, command, enable, shopt, set, unset, shift, history, time, kill, alias, unalias, until, for, while, break, continue, coproc, wait, function, return, declare, local, readonly, export, getopts,
