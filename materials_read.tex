...
\begin{enumerate}
    ...
    \item shell utils and commands:
        \begin{enumerate}
            ...
            \item hostname
            \item gcc, gdb, ctags, cscope, gvim, vim, gvimdiff, python, python3, pip, pip3, pydoc, java, javac, make, diff, patch, ldd, strings, pmap, taskset, node, npm, getopt
            \item ping, iptables
            \item arp, arping
            \item ip (maddress|neighbour)
            \item whois (jwhois)
